  ...
  return (
    <div className="absolute inset-0 z-[60] bg-transparent animate-in slide-in-from-right-full duration-300 flex flex-col">
       ...
       <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="love-card rounded-[1.25rem] shadow-sm p-1">
             <div className="flex justify-between items-center p-4 border-b border-gray-50">
                ...
                >
                  <div className={`w-5 h-5 love-card rounded-full absolute top-0.5 transition-transform shadow-sm ${pushEnabled ? 'translate-x-5' : 'translate-x-0.5'}`}></div>
                </div>
             </div>
             ...
             <div className="flex justify-between items-center p-4 border-b border-gray-50">
                ...
                >
                  <div className={`w-5 h-5 love-card rounded-full absolute top-0.5 transition-transform shadow-sm ${darkMode ? 'translate-x-5' : 'translate-x-0.5'}`}></div>
                </div>
             </div>
          ...
          <button className="w-full love-card text-red-500 font-bold py-3.5 rounded-2xl shadow-sm mt-8 active:bg-transparent transition-colors" onClick={() => { onClose(); onShowToast('已退出登录'); }}>退出登录</button>
       </div>
    </div>
  );
}

  ...
  return (
    <div className="love-card rounded-[1.25rem] p-4 shadow-sm border border-transparent relative group transition-all hover:shadow-md">
      ...
      <div className="flex items-start mb-3">
        ...
        <div className="bg-transparent rounded-2xl rounded-tl-none px-4 py-2.5 text-[14px] text-gray-800 font-medium border border-transparent pr-8">{script.question}</div>
      </div>
      <div className="flex items-start">
        ...
        <div className="flex-1 space-y-2">
          <div className="bg-gradient-to-br from-white to-pink-50/50 rounded-2xl rounded-tr-none px-4 py-3 text-[14px] text-gray-800 relative group/inner border border-pink-100/50">
            <p className="pr-5 leading-relaxed">{script.answers[0]}</p>
            <button onClick={() => onCopy(script.id, script.answers[0])} className="absolute -bottom-2.5 right-2 love-card text-gray-500 border border-transparent shadow-sm p-1.5 rounded-full hover:text-pink-500 hover:scale-110 active:scale-95 transition-all">

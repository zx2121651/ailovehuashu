              ...
              <div>
                <div className="flex gap-4">
                  <div className="flex-1">
                    <label className="block text-sm font-medium mb-1">分类标签</label>
                    <input name="category" defaultValue={editingStory?.category} className="w-full border p-2 rounded" placeholder="例如：恋爱、悬疑" />
                  </div>
                  <div className="flex-1">
                    <label className="block text-sm font-medium mb-1">作者</label>
                    <input name="authorName" defaultValue={editingStory?.authorName} className="w-full border p-2 rounded" placeholder="如：官方" />
                  </div>
                  <div className="w-24">
                    <label className="block text-sm font-medium mb-1">难度星级</label>
                    <input type="number" name="difficulty" defaultValue={editingStory?.difficulty || 1} min="1" max="5" className="w-full border p-2 rounded" />
                  </div>
                </div>
